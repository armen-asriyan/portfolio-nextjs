...
export default function pyfSite() {
  return (
    <article className="group flex flex-col gap-2 bg-gradient-to-b from-sky-400/30 to-purple-800/30 rounded-2xl px-2.5 py-8 cursor-pointer transition-all hover:-translate-y-1">
      {/* Project top section */}
