...
export default function Footer() {
  return (
    <footer className="w-full p-6 overflow-y-auto flex flex-col items-center justify-center gap-2.5 px-8 md:px-16 pt-2.5 pb-8 border-t border-gray-300/30">
      {/* Footer Top section */}
      <div className="w-full flex flex-col md:flex-row items-start justify-center gap-5 py-8">
        ...
        <div className="w-full flex flex-col md:flex-row items-start justify-center gap-5">
          ...
          <div className="w-full flex flex-col items-start justify-center gap-4 px-2">
            <p className="uppercase text-xs text-gray-300/80">NAV</p>
            <a
              href="https://armenasriyan.dev"
              className="text-sm text-white underline transition-colors duration-300 hover:text-gray-400"
            >
              Home
            </a>
            <a
          ...
          {/* Social links  */}
          <div className="w-full flex flex-col items-start justify-center gap-4 px-2">
            <p className="uppercase text-xs text-gray-300/80">SOCIAL</p>
            <a
      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-center gap-2.5 py-2.5">
        <p className="w-full text-sm text-white text-center leading-6 ">
        ...
        <div className="w-full flex items-center justify-center gap-2.5">
          <Link
            href="/legal"
            className="text-sm text-gray-300/80 text-center underline underline-offset-2 transition-colors duration-300 hover:text-white"
          >
            Legal Notice
          </Link>
          <span className="text-sm text-gray-300/80 text-center">|</span>
          <Link
            href="/privacy"
            className="text-sm text-gray-300/80 text-center underline underline-offset-2 transition-colors duration-300 hover:text-white"
          >
